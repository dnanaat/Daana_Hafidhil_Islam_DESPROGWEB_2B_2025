...
<head>
    ...
    <!-- Bootstap -->
    <link href="https://cdnjs.cloudflare.com/ajax/libs/twitterbootstrap/4.1.3/css/bootstrap.css" rel="stylesheet">
...
<body>
    ...
    <div class="container">
        ...
        <div class="text-center mt-4">
            <p>&copy; <?php echo date('Y'); ?> | Desain Dan Pemrograman Web</p>
        </div>
    </div>
