                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="jabatan" aria-label="Default select example">
                                    ...
                                    ?>
                                    <option value="<?php echo $row2['id']; ?>" <?php echo ($row['jabatan_id'] == $row2['id']) ? 'selected' : ''; ?>>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="jenis_kelamin" value="L" <?php echo ($row['jenis_kelamin'] == 'L') ? 'checked' : ''; ?> id="inlineRadio1">
                                    <label class="form-check-label" for="inlineRadio1">Laki-laki</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="jenis_kelamin" value="P" <?php echo ($row['jenis_kelamin'] == 'P') ? 'checked' : ''; ?> id="inlineRadio2">
